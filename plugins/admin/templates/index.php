...
<div class="triggerAnimation animated fadeInRight" data-animate="fadeInRight" style="min-width:600px;max-width:800px;margin: 0 auto;">
    ...
    <div class="form_container responsive" style="width: 450px;">
        ...
        <section class="heading-bordered">
            <h3><?php echo $this::_t( 'Welcome...' )?></h3>
        </section>
        <div class="clearfix"></div>
        
        <fieldset>
        <p><?php echo $this::_t( 'You are in admin section of %s site.', PHS_SITE_NAME )?></p>
        <p><?php echo $this::_t( 'Currently logged in %s - %s.', $current_user['nick'], $this->context_var( 'user_level' ) )?></p>
        </fieldset>
