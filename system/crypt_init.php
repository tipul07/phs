...
if (!empty($PHS_CRYPT_INTERNAL_KEYS_ARR) && is_array($PHS_CRYPT_INTERNAL_KEYS_ARR)) {
    PHS_Crypt::set_internal_keys($PHS_CRYPT_INTERNAL_KEYS_ARR);
} elseif (!empty($PHS_DEFAULT_CRYPT_INTERNAL_KEYS_ARR) && is_array($PHS_DEFAULT_CRYPT_INTERNAL_KEYS_ARR)) {
