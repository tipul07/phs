...
if( ($session_lang = PHS_Session::_g( PHS_Language::LANG_SESSION_KEY ))
 && ($session_lang = PHS_Language::valid_language( $session_lang )) )
{
...
if( ($url_lang = PHS_Params::_gp( PHS_Language::LANG_URL_PARAMETER ))
 && ($url_lang = PHS_Language::valid_language( $url_lang )) )
{
 ...
 && ($current_user = PHS::user_logged_in()) )
{
    ...
    } elseif( empty( $account_language ) || $account_language !== $request_lang_set )
    {
...
if( !empty( $hook_args['default_language'] )
 && PHS_Language::valid_language( $hook_args['default_language'] ) )
{
