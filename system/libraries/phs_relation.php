...
class PHS_Relation
{
    ...
    public function __construct(
        ...
        private readonly string $dest_model_class = '',
        private readonly ?array $dest_flow_arr = [],
        private readonly int $type = self::ONE_TO_ONE,
        private readonly string $dest_key = '',
        private readonly string $link_model_class = '',
        private readonly ?array $link_flow_arr = [],
        private readonly string $link_key = '',
        private readonly string $reverse_key = '',
        private readonly string $link_dest_key = '',
        private readonly ?array $source_flow = [],
        private readonly string $source_key = '',
        private readonly ?PHS_Model_Core_base $source_model = null,
        private readonly ?Closure $filter_fn = null,
        private readonly ?Closure $read_fn = null,
        private readonly int $read_limit = 20,
