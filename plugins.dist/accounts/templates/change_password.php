...
<div style="max-width:1000px;margin: 0 auto;">
    <form id="change_password_form" name="change_password_form" action="<?php echo PHS::url(['p' => 'accounts', 'a' => 'change_password'], $url_extra_args); ?>" method="post">
...
if (!empty($current_user)) {
    ?>
                    <fieldset>
                        <a href="<?php echo PHS::url(['p' => 'accounts', 'a' => 'edit_profile']); ?>"><?php echo $this->_pt('Edit Profile'); ?></a>
                    </fieldset>
                    <?php
}
?>
