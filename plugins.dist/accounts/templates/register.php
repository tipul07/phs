...
?>
            ...
            <fieldset>
                <a href="<?php echo PHS::url(['p' => 'accounts', 'a' => 'login']); ?>"><?php echo $this->_pt('Already have an account'); ?></a>
            </fieldset>

            <fieldset>
                <a href="<?php echo PHS::url(['p' => 'accounts', 'a' => 'forgot']); ?>"><?php echo $this->_pt('I just forgot my password'); ?></a>
            </fieldset>
