...
final class Polynomial
{
     ...
     * @param null|array $num
     * @param null|int $shift
     */
     ...
     */
    public function setNum(array $num, ?int $shift = null) : self
    {
        $offset = 0;
        $numCount = count($num);
     ...
     * @return \chillerlan\QRCode\Helpers\Polynomial
     */
    public function multiply(array $e) : self
    {
     ...
     * @return \chillerlan\QRCode\Helpers\Polynomial
     */
    public function mod(array $e) : self
    {
        $n = $this->num;
