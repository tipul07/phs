...
final class QRMatrix
{
     ...
     */
    public function init(int $maskPattern, ?bool $test = null) : self
    {
        return $this
            ->setFinderPattern()
            ->setSeparators()
     ...
     * @param null|bool $test
     */
    public function setFormatInfo(int $maskPattern, ?bool $test = null) : self
    {
     ...
     * @param int $width
     * @param int $height
     * @param null|int $startX
     * @param null|int $startY
     * @throws \chillerlan\QRCode\Data\QRCodeDataException
     */
     ...
     */
    public function mapData(array $data, int $maskPattern) : self
    {
