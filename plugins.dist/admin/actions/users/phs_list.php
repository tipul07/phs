...
class PHS_Action_List extends PHS_Action_Generic_list
{
     ...
     *
     * @return array|bool Returns true if no error or no action taken, false if there was an error while taking
     *                    action or an action array in case action was taken (with success or not)
     */
