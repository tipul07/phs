...
?>
    ...
    if (!empty($modules_with_settings) && is_array($modules_with_settings)) {
        ?>
        <div class="row">
            <label for="selected_module" class="col-sm-3 col-form-label"><?php echo $this->_pt('Select plugin or a model'); ?></label>
            <div class="col-sm-2" style="min-width:250px;max-width:360px;">
                <select name="selected_module" id="selected_module" class="chosen-select-nosearch"
