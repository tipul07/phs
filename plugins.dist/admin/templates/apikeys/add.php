...
?>
<form id="add_apikey_form" name="add_apikey_form" method="post"
      action="<?php echo PHS::url(['p' => 'admin', 'a' => 'add', 'ad' => 'apikeys']); ?>">
    ...
    <div class="form_container">
        ...
        <div class="form-group row">
            ...
            <small class="text-muted"><?php echo $this->_pt('Leave empty to autogenerate.'); ?></small>
            </div>
        </div>
...
?>
        ...
        <div class="form-group row">
            <input type="submit" id="do_submit" name="do_submit"
                   ...
                   value="<?php echo $this->_pte('Add API key'); ?>" />
        </div>
