<?php
    ...
    if( !($role_units_by_slug = $this->view_var( 'role_units_by_slug' )) )
        $role_units_by_slug = [];
?>
<form id="add_role_form" name="add_role_form" method="post"
      action="<?php echo PHS::url( [ 'p' => 'admin', 'a' => 'role_add' ] )?>">
    ...
    <div class="form_container responsive">
        ...
        <fieldset class="form-group">
            ...
            <div class="lineform_line">
            <input type="text" id="slug" name="slug" class="form-control" required="required"
                   value="<?php echo form_str( $this->view_var( 'slug' ) )?>" autocomplete="off" /><br/>
        ...
        <fieldset>
            <input type="submit" id="do_submit" name="do_submit"
                   ...
                   value="<?php echo $this->_pte( 'Add role' )?>" />
        </fieldset>
