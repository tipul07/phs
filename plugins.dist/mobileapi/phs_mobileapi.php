...
class PHS_Plugin_Mobileapi extends PHS_Plugin
{
    ...
    public static function api_session($session_params = null)
    {
        ...
        if (isset($session_params['session_arr'])) {
            $session_data['session_arr']
                = ((!empty($session_params['session_arr']) && is_array($session_params['session_arr']))
                    ? $session_params['session_arr'] : false);
        }
        if (isset($session_params['account_arr'])) {
            $session_data['account_arr']
                = ((!empty($session_params['account_arr']) && is_array($session_params['account_arr']))
                    ? $session_params['account_arr'] : false);
        }
