...
class PHS_Action_Logout extends PHS_Action
{
    ...
    public function execute()
    {
        ...
        $response_arr = array(
            'session_data' => $online_model->export_data_from_session_data( $session_data['session_arr'] ),
            'account_data' => $mobile_plugin->export_data_from_account_data( $session_data['account_arr'] ),
        );
