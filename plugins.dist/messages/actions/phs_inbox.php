...
class PHS_Action_Inbox extends PHS_Action_Generic_list
{
    ...
    public function load_paginator_params()
    {
        ...
        if (!($m_flow_params = $messages_model->fetch_default_flow_params(['table_name' => 'messages']))
         || !($mu_flow_params = $messages_model->fetch_default_flow_params(['table_name' => 'messages_users']))
         || !($mb_flow_params = $messages_model->fetch_default_flow_params(['table_name' => 'messages_body']))
         ...
         || !($mu_table_name = $messages_model->get_flow_table_name($mu_flow_params))
        ...
        $columns_arr = [
            ...
            [
                ...
                'display_callback'      => [$this, 'display_from'],
            ...
            [
                ...
                'record_field'          => 'from_handle',
                'invalid_value'         => $this->_pt('System'),
                'display_callback'      => [$this, 'display_to'],
            ...
            [
                ...
                'invalid_value'         => $this->_pt('N/A'),
                'display_callback'      => [$this, 'display_subject'],
            ...
            [
                ...
                'display_callback'      => [$this, 'display_last_reply'],
        ...
        $return_arr['base_url'] = PHS::url(['p' => 'messages', 'a' => 'inbox']);
        ...
        switch ($action['action']) {
            ...
            case 'bulk_delete':
                ...
                if (!($scope_arr = $this->_paginator->get_scope())
                 ...
                 || !($scope_key = @sprintf($ids_checkboxes_name, 'mu_id'))
                 || !($scope_all_key = @sprintf($ids_all_checkbox_name, 'mu_id'))
