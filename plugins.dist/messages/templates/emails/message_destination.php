...
?>
Hi <?php echo $this->email_var('destination_nick'); ?>,<br/>
<br/>
On <?php echo $this->email_var('message_date'); ?> you received a new internal message from <?php echo $this->email_var('author_handle'); ?> with subject "<?php echo $this->email_var('message_subject'); ?>".<br/>
<br/>
<?php
